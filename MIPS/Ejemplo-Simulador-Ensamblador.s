...
.data
	# mensajes cargados para imprimir en consola y llamamos caracteres a usar
	mensaje_one: .asciiz 	"\n \n PROGRAMA 2 que muestra el uso del SIMULADOR\n"
	mensaje_dos: .asciiz 	"\n Ingrese entero:  "
	mensaje_three: .asciiz "El entero ingresado es:  "
	ArrayA: .word 3,0,4,5,9
	...
	mensaje_one1: .asciiz "\n\n \t PROGRAMA que muestra el uso de funcion\n"
	mensajetwo: .asciiz "\n Error! El numero N digitado no debe ser negativo (Sucesion de Padovan solo contempla positivos) "
	
.text   
	main:   #Funcion directora, Orquesta la llamada y finaliza
		jal solicitaIN
		jal Simulador
	...
	#**** Funciones con comandos para imprimir string, flotantes, enteros y poner fin del programa
	 ...
	 solicitaIN:
	      ...
	      syscall
              ...
              jal  imprdelimirString  # Para ejecutar imprimir mensaje saltando a la funci�n, desplegamos strin de mensaje 
